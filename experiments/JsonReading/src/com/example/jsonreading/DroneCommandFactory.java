...
public class DroneCommandFactory {
	static DroneCommand getDroneCommand(String key, Object value)
	{
	...
	private static DroneCommand getConfigureCommand(Object value) throws JSONException {
		DroneCommand command = null;
	...
	private static DroneCommand getFlightAnimationCommand(Object value) 
			throws JSONException, InstantiationException, IllegalAccessException, ClassNotFoundException
	{
		...
		if (value instanceof JSONObject)
		{
			...
			if  (anim != null)
			{
				command = new FlightAnimationCommand(anim, duration);
			}
		}
		return command;
	}
	...
	private static DroneCommand getGainsCommand(Object value) throws JSONException {
		DroneCommand command = null;
		if (value instanceof JSONObject)
		{
			JSONObject parameters = (JSONObject)value;
	...
	private static DroneCommand getManualTrimCommand(Object value) throws JSONException {
		DroneCommand command = null;
		if (value instanceof JSONObject)
		{
			JSONObject parameters = (JSONObject)value;
	...
	private static DroneCommand getMiscCommand(Object value) throws JSONException {
		DroneCommand command = null;
		if (value instanceof JSONObject)
		{
			JSONObject parameters = (JSONObject)value;
	...
	private static DroneCommand getPCMDCommand(Object value) throws JSONException {
		DroneCommand command = null;
		if (value instanceof JSONObject)
		{
			JSONObject parameters = (JSONObject)value;
	...
	private static DroneCommand getMoveCommand(Object value) throws JSONException {
		DroneCommand command = null;
		if (value instanceof JSONObject)
		{
			JSONObject parameters = (JSONObject)value;
	...
	private static DroneCommand getPCMDMagCommand(Object value) throws JSONException {
		DroneCommand command = null;
		if (value instanceof JSONObject)
		{
			JSONObject parameters = (JSONObject)value;
	...
	private static DroneCommand getPlayAnimationCommand(Object value) throws JSONException {
		DroneCommand command = null;
		if (value instanceof JSONObject)
		{
			JSONObject parameters = (JSONObject)value;
			...
			int duration = parameters.getInt("duration");
			command = new PlayAnimationCommand(animation_no, duration); 
		}
		return command;
	}

	private static DroneCommand getPMODECommand(Object value) throws JSONException {
		DroneCommand command = null;
		if (value instanceof JSONObject)
		{
			JSONObject parameters = (JSONObject)value;
	...
	private static DroneCommand getRawCaptureCommand(Object value) throws JSONException {
		DroneCommand command = null;
		if (value instanceof JSONObject)
		{
			JSONObject parameters = (JSONObject)value;
	...
	private static DroneCommand getVisionOptionCommand(Object value) throws JSONException {
		DroneCommand command = null;
		if (value instanceof JSONObject)
		{
			JSONObject parameters = (JSONObject)value;
	...
	private static DroneCommand getVisionParametersCommand(Object value) throws JSONException {
		DroneCommand command = null;
		if (value instanceof JSONObject)
		{
			JSONObject parameters = (JSONObject)value;
