...
public class CCFrame extends JFrame implements StateListener, ImageListener, AttitudeListener, BatteryListener {
	...
	public CCFrame(ARDrone ardrone) {
		...
		/*
		 * This is dirty, but JMonkey somehow steals the focus at startup and
		 * without the focus, keyboard input is not processed. Hence one element
		 * requests the focus every second.
		 */
		...
		NavDataManager m = drone.getNavDataManager();
